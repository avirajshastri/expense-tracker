...
const Expense = () => {
  ...
  const handleAddExpense = async (expense) =>{
    ...
    try {
      ...
      console.log("Unable to add expense",error.response?.data?.message || error.message)
    }
  }
  ...
  const deleteExpense = async (id) =>{
    try {
      ...
      console.log("Unable to delete expense item",error.response?.data?.message || error.message)
    }
  }
  ...
  const handleDownloadExpenseDetails = async ()=> {
    try {
      ...
      console.log("Unable to download expense report",error)
